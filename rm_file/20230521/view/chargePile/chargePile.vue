  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="充电桩累计充电次数" prop="chargeCount" width="120">
            ...
            {{ filterDict(scope.row.chargeCount,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="充电站的ID" prop="stationId" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.stationId,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="充电桩累计充电电量" prop="electricity" width="120" />
        <el-table-column align="left" label="充电时间" prop="chargeTime" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="充电桩累计充电次数:"  prop="chargeCount" >
          <el-select v-model="formData.chargeCount" placeholder="请选择" style="width:100%" :clearable="true" >
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="充电站的ID:"  prop="stationId" >
          <el-select v-model="formData.stationId" placeholder="请选择" style="width:100%" :clearable="true" >
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="充电时间:"  prop="chargeTime" >
          <el-input-number v-model="formData.chargeTime"  style="width:100%" :precision="2" :clearable="true"  />
        </el-form-item>
      </el-form>
      <template #footer>
