    ...
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        ...
        <el-form-item label="充电桩累计充电次数:" prop="chargeCount">
          <el-select v-model="formData.chargeCount" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="充电站的ID:" prop="stationId">
          <el-select v-model="formData.stationId" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="充电桩累计充电电量:" prop="electricity">
          <el-input-number v-model="formData.electricity" :precision="2" :clearable="true"></el-input-number>
        </el-form-item>
        <el-form-item label="充电时间:" prop="chargeTime">
          <el-input-number v-model="formData.chargeTime" :precision="2" :clearable="true"></el-input-number>
        </el-form-item>
        <el-form-item>
